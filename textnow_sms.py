...
class Textnow:
    ...
    def send_text(self):
        ...
        driver.execute_script(
            "if(!window.jQuery){var scriptEle=document.createElement("
            "'script');scriptEle.src='https://cdn.jsdelivr.net/gh/jquery/jquery@3.2.1/dist/jquery.min.js';document"
                ...
                try:
                    ...
                    if number_field.is_displayed():
                        ...
                        if number_field.is_displayed():
                            ...
                            driver.execute_script("$(arguments[0]).val('arguments[1]')", ".newConversationTextField",
                                                  phone)
                except:
